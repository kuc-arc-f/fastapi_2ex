...
export const AddForm: React.FC<ItemFormProps> = ({ onSubmit, onCancel, initialData }) => {
  ...
  return (
    <div className="max-w-2xl mx-auto bg-white rounded-xl shadow-lg border border-slate-100 overflow-hidden">
      <div className="px-6 py-4 bg-slate-50 border-b border-slate-100 flex justify-between items-center">
        <h2 className="text-xl font-bold text-slate-800">{initialData ? 'Edit Inventory' : 'Add Text'}</h2>
